...
SCREENS = [
    ...
    ("sue", "月營收優於預期",
     ...
     "成長率，不是分析師預估。過去統計這些股票之後 40 個交易日平均比大盤多 2.3%、"
     "60 天多 3.7%，<b>是這裡唯一明顯超過手續費和稅的名單</b>。", "fact"),
    ("score", "綜合評分",
...
for _k in ['sue']:
    NOTES[_k] = (
        ...
        "過去統計這種股票之後會偏弱。<br><br>"
        "<b>過去表現（2019 年起 71 個營收月份，名單前 20%）：</b><br>"
        "&nbsp;&nbsp;持有 10 天　比大盤多 0.47%<br>"
        "&nbsp;&nbsp;持有 20 天　比大盤多 1.16%<br>"
        "&nbsp;&nbsp;持有 40 天　比大盤多 2.30%<br>"
        "&nbsp;&nbsp;持有 60 天　比大盤多 3.66%<br><br>"
        "好處隨持有時間<b>慢慢累積</b>，八年<b>每一年都是正的</b>，包括 2022 年的空頭。"
        "學術上這叫 PEAD（公布好消息之後，股價會持續往同方向走一段時間），"
        "是全世界研究最多、最穩定的現象之一。<br><br>"
        "<b>怎麼用。</b>效果會隨時間變淡，所以名單只留公布 45 天內的。"
        "適合抱 <b>40–60 個交易日</b>，不是短進短出 —— 抱 10 天的 0.47% 還不夠付 0.6% 的手續費和稅。"
        "<br><br><b>仍要注意</b>：資料只有 2019 年以後、而且只涵蓋成交量最大的約 570 檔。"
        "過去有效不代表以後一定有效。")
